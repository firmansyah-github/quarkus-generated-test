...
group("${entity.tableName}", function() {
	...
	postman[Request]({
      ...
      address: "{{APIURL}}/${entity.instanceName}",
      data:
	...
	postman[Request]({
      ...
      method: "GET",
      options: { timeout: timeout },
      address: "{{APIURL}}/${entity.instanceName}/find?<#list entity.primaryKeyFieldList as fld><#if fld.create  && fld.pkPosition != 0>${fld.fieldName}={{${entity.instanceName}.${fld.fieldName}}}</#if><#sep>&</#list>",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/${entity.instanceName}?offset=0&limit=10&filter=<@xxxpostmancoll_findbyfilter_allfields operator="eq" entity=entity/>&conjunctions=<#list entity.fieldListSortByOrdinalPosition as fld><#if fld.create>OR<#sep>,</#if></#list>",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/${entity.instanceName}?offset=0&limit=10&filter=<@xxxpostmancoll_findbyfilter_allfields operator="eq" entity=entity/>&conjunctions=<#list entity.fieldListSortByOrdinalPosition as fld><#if fld.create>AND<#sep>,</#if></#list>",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/${entity.instanceName}?offset=0&limit=10&filter=<@xxxpostmancoll_findbyfilter_allfields operator="neq" entity=entity/>&conjunctions=<#list entity.fieldListSortByOrdinalPosition as fld><#if fld.create>OR<#sep>,</#if></#list>",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/${entity.instanceName}?offset=0&limit=10&filter=<@xxxpostmancoll_findbyfilter_allfields_like_operator operator="like" entity=entity/>&conjunctions=<#list entity.fieldListSortByOrdinalPosition as fld><#if fld.create && fld.fieldType != "java.time.LocalDateTime">AND<#sep>,</#if></#list>",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/${entity.instanceName}?offset=0&limit=10&filter=<@xxxpostmancoll_findbyfilter_allfields_like_operator operator="nlike" entity=entity/>&conjunctions=<#list entity.fieldListSortByOrdinalPosition as fld><#if fld.create && fld.fieldType != "java.time.LocalDateTime">OR<#sep>,</#if></#list>",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
