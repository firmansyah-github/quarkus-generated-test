package org.example.realworldapi.domain.model.constants;
...
public class ValidationMessages {
	...
	public static final String REQUEST_BODY_MUST_BE_NOT_NULL = "request body must be not null";
  	...
  	public static final String FGUSER_BIO_MAX_LENGTH = "bio of Fguser must not be greater than 255";
 
  	public static final String FGUSER_EMAIL_MAX_LENGTH = "email of Fguser must not be greater than 255";
 
  	public static final String FGUSER_IMAGE_MAX_LENGTH = "image of Fguser must not be greater than 255";
 
  	public static final String FGUSER_PASSWORD_MAX_LENGTH = "password of Fguser must not be greater than 255";
 
  	public static final String FGUSER_USERNAME_MAX_LENGTH = "username of Fguser must not be greater than 255";
 
  	public static final String FGUSER_ID_MUST_BE_NOT_BLANK = "id of Fguser must not be blank";
  	public static final String FGUSER_ID_MAX_LENGTH = "id of Fguser must not be greater than 2,147,483,647";
  	...
  	public static final String SCHOOL_ID_MUST_BE_NOT_BLANK = "id of School must not be blank";
  	public static final String SCHOOL_ID_MAX_LENGTH = "id of School must not be greater than 255";
 
  	public static final String SCHOOL_NAME_MAX_LENGTH = "name of School must not be greater than 255";
