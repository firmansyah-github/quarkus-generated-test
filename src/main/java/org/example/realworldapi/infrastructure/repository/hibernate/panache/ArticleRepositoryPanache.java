...
@ApplicationScoped
@AllArgsConstructor
public class ArticleRepositoryPanache extends AbstractPanacheRepository<ArticleEntity, String>
  ...
  @Override
  public Optional<Article> findByAuthorAndSlug(String authorId, String slug) {
    return find(
