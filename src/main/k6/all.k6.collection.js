...
group("follow_relationship", function() {
	...
	postman[Request]({
      ...
      method: "POST",
      options: { timeout: timeout },
      address: "{{APIURL}}/followRelationship",
      data:
        '{"followRelationship":{"userId":"{{follow_relationship.users}}","followedId":"{{follow_relationship.users}}"}}',
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
	...
	postman[Request]({
      ...
      method: "GET",
      options: { timeout: timeout },
      address: "{{APIURL}}/followRelationship/find?followedId={{followRelationship.followedId}}&userId={{followRelationship.userId}}",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/followRelationship?offset=0&limit=10&filter=userId%7Ceq%7C{{followRelationship.userId}}%7C%7CfollowedId%7Ceq%7C{{followRelationship.followedId}}&conjunctions=OR,OR&sort=-userId,-followedId",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/followRelationship?offset=0&limit=10&filter=userId%7Ceq%7C{{followRelationship.userId}}%7C%7CfollowedId%7Ceq%7C{{followRelationship.followedId}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/followRelationship?offset=0&limit=10&filter=userId%7Ceq%7C{{followRelationship.userId}}%7C%7CfollowedId%7Ceq%7C{{followRelationship.followedId}}&conjunctions=AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/followRelationship?offset=0&limit=10&filter=userId%7Cneq%7C{{followRelationship.userId}}%7C%7CfollowedId%7Cneq%7C{{followRelationship.followedId}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/followRelationship?offset=0&limit=10&filter=userId%7Clike%7C{{followRelationship.userId}}%7C%7CfollowedId%7Clike%7C{{followRelationship.followedId}}&conjunctions=AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/followRelationship?offset=0&limit=10&filter=userId%7Cnlike%7C{{followRelationship.userId}}%7C%7CfollowedId%7Cnlike%7C{{followRelationship.followedId}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
...
group("school", function() {

	postman[Request]({
      name: "Create school for create school",
      id: "2023-08-23-21-45-17-000739",
      method: "POST",
      options: { timeout: timeout },
      address: "{{APIURL}}/school",
      data:
        '{"school":{"id":"{{UNIQUE}}","name":"name"}}',
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
      ...
      post(response) {
        ...
        tests["Response code is 201 OK - Create school for create school"] = is201Response;

        if (!environment.isIntegrationTest && is201Response) {
          var responseJSON = JSON.parse(responseBody);

          tests[
            'Response contains "school" property'
          ] = responseJSON.hasOwnProperty("school");
	...
	postman[Request]({
      name: "Find school By Primary Key",
      id: "2023-08-23-21-45-17-000739",
      method: "GET",
      options: { timeout: timeout },
      address: "{{APIURL}}/school/find?id={{school.id}}",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
      ...
      post(response) {
        ...
        tests['Response code is 200 OK - Find school By Primary Key'] = is200Response;
	    ...
	    if (!(environment.isIntegrationTest) && is200Response) {
		    ...
		    if(tests['school has "name" property']){
            	pm.globals.set('school.name', school.name);
            }
            
            tests['Global variable "school.name" has been set'] = pm.globals.get('school.name') === school.name;
    ...
    postman[Request]({
      name:
        "Find school By Filter With Offset0 And Limit10, All Fields, Equals, Or, Sort Desc",
      id: "2023-08-23-21-45-17-000739",
      method: "GET",
      options: { timeout: timeout },
      address:
        "{{APIURL}}/school?offset=0&limit=10&filter=id%7Ceq%7C{{school.id}}%7C%7Cname%7Ceq%7C{{school.name}}&conjunctions=OR,OR&sort=-id,-name",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
      ...
      post(response) {
        ...
        tests['Find school By Filter With Offset0 And Limit10, All Fields, Equals, Or, Sort Desc - Response code is 200 OK'] = is200Response;
	    ...
	    if (!(environment.isIntegrationTest) && is200Response) {
	        ...
	        if (typeof school === 'object' && Array.isArray(school) && school.length > 0) {
			    ...
			    '	Response should be an array': (arr) => Array.isArray(arr) && arr.length > 0,
			  	...
			  	// Check if 'school' has the same length as the response array length
			  	check(school, {
			    '	Response array length should match': (arr) => arr.length === school.length,
			  	});
    ...
    postman[Request]({
      name:
        "Find school By Filter With Offset0 And Limit10, All Fields, Equals, Or, Sort Asc",
      id: "2023-08-23-21-45-17-000739",
      method: "GET",
      options: { timeout: timeout },
      address:
      ...
      post(response) {
        ...
        tests['Find school By Filter With Offset0 And Limit10, All Fields, Equals, Or, Sort Asc - Response code is 200 OK'] = is200Response;
    ...
    postman[Request]({
      name:
        "Find school By Filter With Offset0 And Limit10, All Fields, Equals, Or Conjunctions",
      id: "2023-08-23-21-45-17-000739",
      method: "GET",
      options: { timeout: timeout },
      address:
        "{{APIURL}}/school?offset=0&limit=10&filter=id%7Ceq%7C{{school.id}}%7C%7Cname%7Ceq%7C{{school.name}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
      ...
      post(response) {
        ...
        tests['Find school By Filter With Offset0 And Limit10, All Fields, Equals, Or Conjunctions - Response code is 200 OK'] = is200Response;
    ...
    postman[Request]({
      name:
        "Find school By Filter With Offset0 And Limit10, All Fields, Equals, And Conjunctions",
      id: "2023-08-23-21-45-17-000739",
      method: "GET",
      options: { timeout: timeout },
      address:
        "{{APIURL}}/school?offset=0&limit=10&filter=id%7Ceq%7C{{school.id}}%7C%7Cname%7Ceq%7C{{school.name}}&conjunctions=AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
      ...
      post(response) {
        ...
        tests['Find school By Filter With Offset0 And Limit10, All Fields, Equals, And Conjunctions - Response code is 200 OK'] = is200Response;
    ...
    postman[Request]({
      name:
        "Find school By Filter With Offset0 And Limit10, All Fields, Not Equals, Or Conjunctions",
      id: "2023-08-23-21-45-17-000739",
      method: "GET",
      options: { timeout: timeout },
      address:
        "{{APIURL}}/school?offset=0&limit=10&filter=id%7Cneq%7C{{school.id}}%7C%7Cname%7Cneq%7C{{school.name}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
      ...
      post(response) {
        ...
        tests['Find school By Filter With Offset0 And Limit10, All Fields, Not Equals, Or Conjunctions - Response code is 200 OK'] = is200Response;
    ...
    postman[Request]({
      name:
        "Find school By Filter With Offset0 And Limit10, All Fields, Like, And Conjunctions",
      id: "2023-08-23-21-45-17-000739",
      method: "GET",
      options: { timeout: timeout },
      address:
        "{{APIURL}}/school?offset=0&limit=10&filter=id%7Clike%7C{{school.id}}%7C%7Cname%7Clike%7C{{school.name}}&conjunctions=AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
      ...
      post(response) {
        ...
        tests['Find school By Filter With Offset0 And Limit10, All Fields, Like, And Conjunctions - Response code is 200 OK'] = is200Response;
    ...
    postman[Request]({
      name:
        "Find school By Filter With Offset0 And Limit10, All Fields, Not Like, Or Conjunctions",
      id: "2023-08-23-21-45-17-000739",
      method: "GET",
      options: { timeout: timeout },
      address:
        "{{APIURL}}/school?offset=0&limit=10&filter=id%7Cnlike%7C{{school.id}}%7C%7Cname%7Cnlike%7C{{school.name}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
      ...
      post(response) {
        ...
        tests['Find school By Filter With Offset0 And Limit10, All Fields, Not Like, Or Conjunctions - Response code is 200 OK'] = is200Response;
...
group("tags", function() {
	...
	postman[Request]({
      ...
      method: "GET",
      options: { timeout: timeout },
      address: "{{APIURL}}/tags/find?id={{tags.id}}",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/tags?offset=0&limit=10&filter=id%7Ceq%7C{{tags.id}}%7C%7Cname%7Ceq%7C{{tags.name}}&conjunctions=OR,OR&sort=-id,-name",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/tags?offset=0&limit=10&filter=id%7Ceq%7C{{tags.id}}%7C%7Cname%7Ceq%7C{{tags.name}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/tags?offset=0&limit=10&filter=id%7Ceq%7C{{tags.id}}%7C%7Cname%7Ceq%7C{{tags.name}}&conjunctions=AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/tags?offset=0&limit=10&filter=id%7Cneq%7C{{tags.id}}%7C%7Cname%7Cneq%7C{{tags.name}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/tags?offset=0&limit=10&filter=id%7Clike%7C{{tags.id}}%7C%7Cname%7Clike%7C{{tags.name}}&conjunctions=AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/tags?offset=0&limit=10&filter=id%7Cnlike%7C{{tags.id}}%7C%7Cname%7Cnlike%7C{{tags.name}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
...
group("users", function() {
	...
	postman[Request]({
      ...
      method: "GET",
      options: { timeout: timeout },
      address: "{{APIURL}}/users/find?id={{users.id}}",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/users?offset=0&limit=10&filter=id%7Ceq%7C{{users.id}}%7C%7Cbio%7Ceq%7C{{users.bio}}%7C%7Cemail%7Ceq%7C{{users.email}}%7C%7Cimage%7Ceq%7C{{users.image}}%7C%7Cpassword%7Ceq%7C{{users.password}}%7C%7Cusername%7Ceq%7C{{users.username}}&conjunctions=OR,OR,OR,OR,OR,OR&sort=-id,-bio,-email,-image,-password,-username",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/users?offset=0&limit=10&filter=id%7Ceq%7C{{users.id}}%7C%7Cbio%7Ceq%7C{{users.bio}}%7C%7Cemail%7Ceq%7C{{users.email}}%7C%7Cimage%7Ceq%7C{{users.image}}%7C%7Cpassword%7Ceq%7C{{users.password}}%7C%7Cusername%7Ceq%7C{{users.username}}&conjunctions=OR,OR,OR,OR,OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/users?offset=0&limit=10&filter=id%7Ceq%7C{{users.id}}%7C%7Cbio%7Ceq%7C{{users.bio}}%7C%7Cemail%7Ceq%7C{{users.email}}%7C%7Cimage%7Ceq%7C{{users.image}}%7C%7Cpassword%7Ceq%7C{{users.password}}%7C%7Cusername%7Ceq%7C{{users.username}}&conjunctions=AND,AND,AND,AND,AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/users?offset=0&limit=10&filter=id%7Cneq%7C{{users.id}}%7C%7Cbio%7Cneq%7C{{users.bio}}%7C%7Cemail%7Cneq%7C{{users.email}}%7C%7Cimage%7Cneq%7C{{users.image}}%7C%7Cpassword%7Cneq%7C{{users.password}}%7C%7Cusername%7Cneq%7C{{users.username}}&conjunctions=OR,OR,OR,OR,OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/users?offset=0&limit=10&filter=id%7Clike%7C{{users.id}}%7C%7Cbio%7Clike%7C{{users.bio}}%7C%7Cemail%7Clike%7C{{users.email}}%7C%7Cimage%7Clike%7C{{users.image}}%7C%7Cpassword%7Clike%7C{{users.password}}%7C%7Cusername%7Clike%7C{{users.username}}&conjunctions=AND,AND,AND,AND,AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/users?offset=0&limit=10&filter=id%7Cnlike%7C{{users.id}}%7C%7Cbio%7Cnlike%7C{{users.bio}}%7C%7Cemail%7Cnlike%7C{{users.email}}%7C%7Cimage%7Cnlike%7C{{users.image}}%7C%7Cpassword%7Cnlike%7C{{users.password}}%7C%7Cusername%7Cnlike%7C{{users.username}}&conjunctions=OR,OR,OR,OR,OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
...
group("favorite_relationship", function() {
	...
	postman[Request]({
      ...
      method: "POST",
      options: { timeout: timeout },
      address: "{{APIURL}}/favoriteRelationship",
      data:
        '{"favoriteRelationship":{"userId":"{{favorite_relationship.users}}","articleId":"{{favorite_relationship.articles}}"}}',
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
	...
	postman[Request]({
      ...
      method: "GET",
      options: { timeout: timeout },
      address: "{{APIURL}}/favoriteRelationship/find?articleId={{favoriteRelationship.articleId}}&userId={{favoriteRelationship.userId}}",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/favoriteRelationship?offset=0&limit=10&filter=userId%7Ceq%7C{{favoriteRelationship.userId}}%7C%7CarticleId%7Ceq%7C{{favoriteRelationship.articleId}}&conjunctions=OR,OR&sort=-userId,-articleId",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/favoriteRelationship?offset=0&limit=10&filter=userId%7Ceq%7C{{favoriteRelationship.userId}}%7C%7CarticleId%7Ceq%7C{{favoriteRelationship.articleId}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/favoriteRelationship?offset=0&limit=10&filter=userId%7Ceq%7C{{favoriteRelationship.userId}}%7C%7CarticleId%7Ceq%7C{{favoriteRelationship.articleId}}&conjunctions=AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/favoriteRelationship?offset=0&limit=10&filter=userId%7Cneq%7C{{favoriteRelationship.userId}}%7C%7CarticleId%7Cneq%7C{{favoriteRelationship.articleId}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/favoriteRelationship?offset=0&limit=10&filter=userId%7Clike%7C{{favoriteRelationship.userId}}%7C%7CarticleId%7Clike%7C{{favoriteRelationship.articleId}}&conjunctions=AND,AND",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
    ...
    postman[Request]({
      ...
      options: { timeout: timeout },
      address:
        "{{APIURL}}/favoriteRelationship?offset=0&limit=10&filter=userId%7Cnlike%7C{{favoriteRelationship.userId}}%7C%7CarticleId%7Cnlike%7C{{favoriteRelationship.articleId}}&conjunctions=OR,OR",
      headers: {
        "Content-Type": "application/json",
        "X-Requested-With": "XMLHttpRequest",
        Authorization: "Token {{token}}"
...
export function handleSummary(data) {
  ...
  //const LocalDateTimeNow = rpt;//"k6/reports/all.pt."+formattedDate+myVar+".html";
  return {
    [rpt] : htmlReport(data),
